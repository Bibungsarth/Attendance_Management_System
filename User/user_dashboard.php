...
if ($result1=mysqli_query($conn,$sql1))
{
  ...
  <div class="card2"><h6>Attandence</h6><h5> <?php print round($percentage,2); ?>% <progress  id="file" value="<?php print round($percentage,2); } }?>" max="100"> </progress> <i class="fas fa-tasks"></i>
</h5>
