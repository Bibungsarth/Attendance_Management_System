...
.bg {
  background: linear-gradient(to bottom right, #662d91 0%, #ccffff 100%);
}
.navbar {
  padding : 0%;
  background: linear-gradient(to bottom right, #000000 0%, #660066 100%);
}
  .contact-form{
...
.card{
  ...
  <a class="navbar-brand" href="index.php">OnliAttenger</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <span class="navbar-text">
     <a href="Login.php"><button class="btn btn-outline-primary"> STUDENTS </button></a>
    </span>
  </div>
</nav>
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <p style="color: skyblue;">Students who regularly meet with mentors are 52% less likely than their peers to skip a day of school, 37% less likely than their peers to skip a class period, and are 36% more likely to aspire to enroll in and graduate from college.</p>
     <a href="Admin/login.php"><button type="button" class="btn btn-outline-info"> TEACHER </button></a>
  </div>
    </div>
...
<div class="container contact-form" id="contact">
  <form method="post">
                <h3>Leave a Message <i class="fas fa-phone"></i></h3>
               <div class="row">
                    <div class="col-md-6">
...
<footer class="page-footer font-small blue">
  ...
  <div class="footer-copyright text-center py-3">© 2022 Copyright:
    <a href="copyright.php"> OnliAttenger.com</a>
  </div>
  <!-- Copyright -->
